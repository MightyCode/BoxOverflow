...
public class MenuScreen extends Screen {
    ...
    public MenuScreen(GameManager gameManager) {
        super(gameManager);
        // Load the screen
        Render.setClearColor(0.8f,0.8f,0.8f, 1f);
        ...
        if(Empty.admin) admin = new FontRenderer("Mode admin", StaticFonts.monofonto, Window.width*0.02f,
